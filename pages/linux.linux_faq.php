...
<main role="main">
  <section id="faq">
    ...
    <div id="content">
      ...
      <?php print _("Installing GNU/Linux:"); ?>
      <ul>
    ...
    <div class="answer">
        ...
        <p><?php print _("To avoid confusion, we use \"GNU/Linux\" to refer to operating systems that include <a href=\"https://gnu.org/\">GNU</a> software and the <a href=\"https://kernel.org/\">Linux kernel</a>. When we use \"Linux\" without the GNU part, we refer to the kernel."); ?></p>
    </div><!-- end answer -->
    </div><!-- end QA -->
    ...
    <div>
    <h3 id="mac"><?php print _("Is Mac OS X a distribution of GNU/Linux?"); ?></h3>
    <div class="answer">
        <p><?php
        # translators: Use localized URL of free software definition on GNU.org in place of softwareliberty.com
        $p = _("No. There are a few <a href=\"http://www.softwareliberty.com/\">free software</a> components in Mac OS X, and it is technically similar to GNU/Linux systems. But overall, it is proprietary software: all the <a href=\"%s\">issues about Windows</a> apply to it as well."); printf($p, $this->base_url('windows',1)); ?></p>
    </div><!-- end answer -->
    </div><!-- end QA -->
    ...
    <div class="answer">
        ...
        <p><?php print _("Mac OS X does have some low-level components which are <a href=\"http://www.softwareliberty.com/\">free software</a>; and Apple puts less energy into customer lock-in (with some notable efforts such as BootCamp)."); ?><br />
        <?php print _("However, the end-user is still fundamentally restricted &mdash; because of the proprietary license, he/she cannot use Mac OS X for all purposes, nor copy, study, modify, or redistribute it."); ?></p>
    ...
    <div class="answer">
        ...
        print _("Yes it does! We have built a website specially for that purpose, <a href=\"http://linuxpreloaded.com/\" title=\"Linux laptops\">LinuxPreloaded.com</a>, listing vendors that sell GNU/Linux desktops and laptops."); ?></p>
        <p><?php
    ...
    <div class="answer">
        ...
        <p><?php print _("There is a legal solution to play your DVDs on GNU/Linux where <code>libdvdcss</code> is illegal. The <a href=\"http://www.fluendo.com/\">Fluendo</a> company has developed an (non-free) application for that purpose which can be purchased from their website."); ?></p>
    ...
    <div class="answer">
        <p><?php print _("Yes and No: Some games, for example some <a href=\"http://www.idsoftware.com/\">id Software</a> games like the Quake series and Doom 3, Unreal Tournament, Cold War, and many more have GNU/Linux versions."); ?></p>
