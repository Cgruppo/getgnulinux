...
<main role="main">
  ...
  <section>
    <div class="maxwidth">
      ...
      <article>
        ...
        print _("It is often difficult for Windows users to believe that there are <em>no spyware nor viruses</em> under GNU/Linux &mdash; <a href=\"http://linuxmafia.com/~rick/faq/index.php?page=virus#virus\">but it's true</a>. Malicious programs have a hard time doing anything at all in a well-built system."); ?></p>
  ...
  <section>
    <div class="maxwidth">
      ...
      <p><?php print _("Fundamentally, everyday users will find GNU/Linux similar in use to Windows or Mac OS X."); ?></p>
