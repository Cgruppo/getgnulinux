  ...
  <section>
    <div class="maxwidth">
      ...
      <div class="page-intro">
        <p><?php print _("Make the step &ndash; unless you wish to <a href=\"http://linuxpreloaded.com/\" title=\"Linux Desktops and Laptops\">purchase a PC with GNU/Linux pre-installed</a>, you can see what freedom looks like on your computer."); ?></p>
      </div>
    </div>
  </section>
...
We have compiled <a title=\"linux computers\" href=\"http://linuxpreloaded.com/\">a list of vendors pre-installing GNU/Linux at LinuxPreloaded.com</a> just for that reason."); ?></p>
    </div>
  </section>
